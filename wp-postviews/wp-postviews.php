...
Description: 统计并显示每篇文章及页面的访客阅读数量。
Version: 1.7.2
Author: OSSLab
...
function views_activation( $network_wide ) {
	...
	$option = array(
		...
		, 'display_other'           => 0
		, 'use_ajax'                => 1
		, 'template'                => __('浏览 （%VIEW_COUNT%）', 'wp-postviews')
		, 'most_viewed_template'    => '<li><a href="%POST_URL%"  title="%POST_TITLE%">%POST_TITLE%</a> - %VIEW_COUNT% '.__('次浏览', 'wp-postviews').'</li>'
	);

...
Description: 轻松定制 WordPress 登录界面及仪表盘版权说明。
...
/* Creates new database field */
    ...
    $er_new_options = array(
        'dashboard_data_left' => '感谢使用WordPress进行创作。',
        ...
        'dashboard_power_text' => '感谢使用WordPress进行创作。',
...
value="<?php echo $er_options['top_bg_image']; ?>" /><button class="set_custom_images button"><?php _e( 'Add Background Image', 'erident-custom-login-and-dashboard' ); ?></button>
  ...
  <tr valign="top">
    ...
    <select class="er-textfield-small" name="er_options_up[top_bg_repeat]" id="wp_erident_top_bg_repeat">
      <option value="no-repeat" <?php echo $er_screen_a; ?>>不重复</option>
      <option value="repeat" <?php echo $er_screen_b; ?>>平铺</option>
      <option value="repeat-x" <?php echo $er_screen_c; ?>>水平平铺</option>
      <option value="repeat-y" <?php echo $er_screen_d; ?>>垂直平铺</option>
    </select>
...
value="<?php echo $er_options['top_bg_xpos']; ?>" />
	垂直对齐：<input class="er-textfield-small" name="er_options_up[top_bg_ypos]" type="text" id="wp_erident_top_bg_ypos"
...
value="<?php echo $er_options['dashboard_login_radius']; ?>" />px
  ...
  <tr valign="top">
    ...
    <select class="er-textfield-small" name="er_options_up[dashboard_login_border]" id="wp_erident_dashboard_login_border">
      <option value="none" <?php echo $er_a; ?>>无</option>
      <option value="solid" <?php echo $er_b; ?>>实线</option>
      <option value="dotted" <?php echo $er_c; ?>>圆点</option>
      <option value="dashed" <?php echo $er_d; ?>>虚线</option>
      <option value="double" <?php echo $er_e; ?>>双线</option>
    </select>
...
value="<?php echo $er_options['dashboard_border_thick']; ?>" />px
  ...
  <tr valign="top">
    ...
    <select class="er-textfield-small" name="er_options_up[login_bg_repeat]" id="wp_erident_login_bg_repeat">
      <option value="no-repeat" <?php echo $er_login_a; ?>>不重复</option>
      <option value="repeat" <?php echo $er_login_b; ?>>平铺</option>
      <option value="repeat-x" <?php echo $er_login_c; ?>>水平平铺</option>
      <option value="repeat-y" <?php echo $er_login_d; ?>>垂直平铺</option>
    </select>
...
<div class="bottom-notices" style="display:none">

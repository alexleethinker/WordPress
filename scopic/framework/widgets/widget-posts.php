...
'description'	=>	__( '您站点定制的数篇文章。', 'framework' )
)
);
...
<p>
  <label for="<?php echo $this->get_field_id("sort_by"); ?>">
    <?php _e( '排序方式', 'framework' ); ?>
    :
    <select id="<?php echo $this->get_field_id("sort_by"); ?>" name="<?php echo $this->get_field_name("sort_by"); ?>">
      <option value="date"<?php selected( $instance["sort_by"], "date" ); ?>><?php _e( '日期', 'framework' ); ?></option>
      <option value="title"<?php selected( $instance["sort_by"], "title" ); ?>><?php _e( '标题', 'framework' ); ?></option>
      <option value="comment_count"<?php selected( $instance["sort_by"], "comment_count" ); ?>><?php _e( '评论', 'framework' ); ?></option>
      <option value="random"<?php selected( $instance["sort_by"], "random" ); ?>><?php _e( '随机', 'framework' ); ?></option>
    </select>
  </label>
</p>
<p>

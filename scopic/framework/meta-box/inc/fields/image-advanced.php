...
if ( ! class_exists( 'RWMB_Image_Advanced_Field' ) )
{
	class RWMB_Image_Advanced_Field extends RWMB_Image_Field
	{
		...
		{
			$i18n_delete = apply_filters( 'rwmb_image_delete_string', _x( '删除', 'image upload', 'rwmb' ) );
			$i18n_edit   = apply_filters( 'rwmb_image_edit_string', _x( '编辑', 'image upload', 'rwmb' ) );
			?>

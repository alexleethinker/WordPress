...
?>
    ...
    <div id="comments" class="comments-area">
		...
		<nav id="comment-nav-above" class="navigation-comment" role="navigation">
			<h1 class="screen-reader-text"><?php _e( '全部评论', 'framework' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; 上一页', 'framework' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( '下一页 &rarr;', 'framework' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php _e( '评论已关闭。', 'framework' ); ?></p>
